...
class SendSms():
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> core.kahvedunyasi.com")
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> wmf.com.tr")
    ...
    def TiklaGelsin(self):
        try:
            ...
            if r.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> svc.apps.tiklagelsin.com")
    ...
    def Ayyildiz(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> api.altinyildizclassics.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> api.altinyildizclassics.com")
    ...
    def Naosstars(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> api.naosstars.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> api.naosstars.com")
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> bim.veesk.net")
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> englishhome.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> englishhome.com")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["response"]["statusCode"] == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> u.icq.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> u.icq.net")
    ...
    def Evidea(self):
        try:
            ...
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> evidea.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> evidea.com") 
    ...
    def Marti(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> customer.martiscooter.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> customer.martiscooter.com")
    ...
    def Hey(self):
        try:
            ...
            r = requests.post(url, headers=headers)
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> heyapi.heymobility.tech")
    ...
    def Bineq(self):
        try:
            ...
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> bineqapi.heymobility.tech")
    ...
    def Tasimacim(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> server.tasimacim.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> server.tasimacim.com")
    ...
    def Yuffi(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> api.yuffi.co")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> api.yuffi.co")
    ...
    def Sok(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> api.ceptesok.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> api.ceptesok.com")
    ...
    def Migros(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> rest.migros.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> rest.migros.com.tr")
    ...
    def kigili(self):
        try:
            ...
            if response.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By atomto | [+] {Style.RESET_ALL}S2tim Ez! {self.phone} --> kigili.com")
                self.adet += 1   
            else:
                raise

        except Exception as e:
            print(f"{Fore.LIGHTRED_EX}Made By atomto | [-] {Style.RESET_ALL}Olmadi bida deneyem! {self.phone} --> kigili.com")
            print(str(e))